...
class AuthService {
  ...
  Future getProfileImage() async {
    if (_firebaseAuth.currentUser!.photoURL != null) {
      return Image.network(_firebaseAuth.currentUser!.photoURL.toString(),
  ...
  Future singInAnonymously() async {
    try {
      dynamic result = await _firebaseAuth.signInAnonymously();
      user = result.user;
      return user;
    } catch (e) {
      print(e.toString());
  ...
  Future convertWithGoogle() async {
    ...
    await updateUserName(
        _googleSignIn.currentUser!.displayName.toString(), currentUser);
  }
